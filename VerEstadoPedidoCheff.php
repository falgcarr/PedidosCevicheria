...
<html lang="en">
 ...
 <div class="navbar navbar-inverse ">
      <div class="navbar-inner"> 
            <a  class="brand"  href="pedidosCheff.php">Regresar</a>
...
contar($result);
 ...
 while($row = mysql_fetch_array( $result )) {
      ...
      echo " <a class='btn btn-danger' href='./CambiarEstadoPedidoCheff.php?NumCom=".$row[0]."&CodPro=".$row[1]."&Cant=".$row[3]."'><i class='icon-trash icon-white'></i>ListoParaRecoger</a>";
      echo "</td>";
      }
      echo "</tr>"; 
