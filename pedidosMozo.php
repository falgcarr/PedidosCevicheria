 <div class="navbar navbar-inverse ">
      <div class="navbar-inner"> 
            <a  class="brand"  href="tables.php">Ver Mesas y editar Pedidos</a>
    ...
    $result = mysql_query("SELECT * FROM comanda WHERE CodPer =2342 ") 
    or die(mysql_error());  

    echo "<table class='table table-striped table-bordered'>";
    echo "<thead> <th>NumCom</th> <th>CodPer</th> <th>NumMesa</th> <th>Ver Productos</th> <th>Editar</th> </thead>";
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      echo $row[2];
      echo "</td><td>"; 
      echo "<a data-toggle='dropdown' href='./VerEstadoPedidoMozo.php?NumCom=".$row['NumCom']."' class='btn btn-primary btn-small'>Ver Productos</a>";
      echo "</td><td>"; 
      echo $row[2];
      echo "</td></tr>"; 
    } 
