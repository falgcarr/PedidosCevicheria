...
$numplatos=$CantidadPlatos - 1;
echo $numplatos;
$querya="UPDATE `puntoblanco`.`detallecomanda` SET `Cant`='".$numplatos."' WHERE `detallecomanda`.`NumCom`='".$CodigoComanda."' AND `detallecomanda`.`CodPro`='".$CodigoPlato."' ";
