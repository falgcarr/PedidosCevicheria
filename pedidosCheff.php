 <div class="navbar navbar-inverse ">
    ...
    echo "<thead> <th>NumCom</th> <th>CodPer</th> <th>NumMesa</th> <th>Ver Productos</th> </thead>";
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      echo $row[2];
      echo "</td><td>"; 
      echo "<a data-toggle='dropdown' href='./VerEstadoPedidoCheff.php?NumCom=".$row['NumCom']."' class='btn btn-primary btn-small'>Ver Productos</a>";
      echo "</td>"; 
      echo "</tr>"; 
    } 
